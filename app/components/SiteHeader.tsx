  ...
  return (
    <header className="site-header">
      <nav className="top-nav" aria-label="Primary navigation">
        <a className="home-link" href={home} aria-label={locale === "ru" ? "Главная" : "Home"} title={locale === "ru" ? "Главная" : "Home"}>
          <span className="home-icon" aria-hidden="true" />
        </a>
        <a href={localePath(locale, "/about")}>{text.about}</a>
        <a href={localePath(locale, "/search")}>{text.search}</a>
      ...
      <div className="journal-identity">
        <a className="wordmark" href={home} aria-label="UNFOLDING">
