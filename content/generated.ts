...
export const publishedEntries: PublishedEntry[] = [
  {
    "id": "cb5cf5c3-7209-41ae-ab64-b3446dd68442",
    "originalLanguage": "en",
    "versions": {
      "en": {
        "locale": "en",
        "slug": "how-local-errors-accumulate",
        "title": "How Local Errors Accumulate",
        "createdAt": "2026-08-16T06:50:24+03:00",
        "publishedAt": "2026-08-16T06:55:14+03:00",
        "tags": [
        ...
        "externalLinks": [
          {
            "id": "ced9f5e2-9f9a-4f75-9310-2fed23d05830",
            "type": "github",
            "url": "https://github.com/avikulova/study-math/blob/main/calculus/exact-annulus-vs-rectangle.md",
            "label": "Source material"
          }
        ],
        "excerpt": "We can make an approximation increasingly precise by dividing a system into smaller and smaller parts. But there is a question that the accuracy of each individual part does not answer: What happens when all of…",
      ...
      "ru": {
        "locale": "ru",
        "slug": "how-local-errors-accumulate",
        "title": "Как накапливаются локальные ошибки",
        "createdAt": "2026-08-16T06:50:24+03:00",
        "publishedAt": "2026-08-16T06:55:15+03:00",
        "tags": [
        ...
        "excerpt": "Мы можем делать приближение всё более точным, разделяя систему на всё более мелкие части. Но точность каждой отдельной части ещё не отвечает на другой вопрос: Что происходит, когда все эти небольшие ошибки скла…",
  ...
  },
  {
    ...
    "versions": {
      "ru": {
        ...
        "publishedAt": "2026-08-16T06:55:13+03:00",
        "tags": [
          "математический анализ",
          "предел последовательности",
        ...
        "excerpt": "Площадь круга как предел конечных приближений Мы уже знаем точную площадь круга: A=\\pi R^2. Поэтому цель этого исследования не в том, чтобы заново вывести известную формулу. Вместо этого мы можем использовать к…",
      ...
      "en": {
        ...
        "excerpt": "The Area of a Circle as a Limit of Finite Approximations We already know the exact area of a circle: A=\\pi R^2. So the purpose of this experiment is not to derive the familiar formula again. Instead, we can use…",
  ...
  },
  {
    ...
    "versions": {
      "ru": {
        ...
        "publishedAt": "2026-08-15T05:31:46+03:00",
        "tags": [
          "творчество",
          "письмо",
          "созерцание",
        ...
        "externalLinks": [],
        "excerpt": "Что, если протянуть сквозь день магию утра? Летняя ночь без сна. На рассвете открыла окно. Свежесть и прохлада неподвижного воздуха. Ветви деревьев, замершие как в стоп-кадре. Ни пение птиц, никакие другие звук…",
        "body": "Что, если протянуть сквозь день магию утра? \n\nЛетняя ночь без сна. \n\nНа рассвете открыла окно. Свежесть и прохлада неподвижного воздуха. Ветви деревьев, замершие как в стоп-кадре. Ни пение птиц, никакие другие звуки ещё не нарушают тишину прошедшей ночи. Верхушки сосен подсвечены солнечными лучами, проходящими сквозь розовые облака. Небо прозрачно-голубое с несколькими легкими белыми тучками, мягко плывущими в мою сторону. \n\nЧто отличает это время суток от других часов дня? Почему так легко созерцание? Почему сознание замирает вместе с природой? В чем эта магия?\n"
      },
      "en": {
        "locale": "en",
        "slug": "magic-of-dawn",
